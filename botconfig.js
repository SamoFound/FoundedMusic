module.exports = {
  Admins: ["653960359559954453", "UserID"], // Admins of the bot, I don't know what this do. -Darren.
  ExpressServer: true, // If you wanted to make the website run or not
  DefaultPrefix: process.env.Prefix || "!", // Default prefix, Server Admins can change the prefix
  Port: 3000, //Which port website gonna be hosted
  SupportServer: "https://discord.gg/XRJd6mWdcv", // Support Server Link
  Token: process.env.Token || HEROKU_TOKEN, // Discord Bot Token
  ClientID: process.env.Discord_ClientID || "987774740678713414", // Discord Client ID
  ClientSecret: process.env.Discord_ClientSecret || HEROKU_SECRET, // Discord Client Secret
  ...
  CookieSecret: "Coding is stressfull", // A cookie for you, cookie for me. make sure you change this value!
  IconURL:
  ...
  Spotify: {
    ClientID: process.env.Spotify_ClientID || "1b62778d05e24200975da9e683e49826", // Spotify Client ID
    ClientSecret: process.env.Spotify_ClientSecret || "629273994f0a44c3bca250b04dd7e564", // Spotify Client Secret
  },
};
